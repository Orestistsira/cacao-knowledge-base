...
def stix_to_playbook(stix_playbook: StixPlaybook) -> Playbook:
    ...
    return Playbook(
        ...
        playbook_processing_summary=extension.get("playbook_processing_summary"),
        derived_from=extension.get("derived_from"),
        related_to=extension.get("related_to"),
        priority=extension.get("playbook_priority"),
        severity=extension.get("playbook_severity"),
        impact=extension.get("playbook_impact"),
        industry_sectors=extension.get("industry_sectors"),
        labels=extension.get("labels"),
        external_references=extension.get("external_references"),
        markings=extension.get("markings"),
        playbook_variables=extension.get("playbook_variables"),
